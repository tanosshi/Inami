  ...
  const SettingPress = (codename: string, type: string) => {
    ...
    switch (codename) {
      ...
      case "customize":
        ...
        break;
      case "fetch_id3":
        navigateTo("/settings/fetch-id3");
        break;
      case "syncing":
        navigateTo("/settings/syncing");
        break;
      case "lastfm":
        navigateTo("/settings/lastfm");
        break;
      case "discover":
        navigateTo("/settings/discovery");
        break;
      case "search":
        navigateTo("/settings/search");
        break;
      case "dlmusic":
        navigateTo("/settings/download");
        break;
      case "redo_welcome":
        navigateTo("/landing");
        break;
